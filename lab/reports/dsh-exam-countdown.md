...
- **来源**: `https://codeload.github.com/zimai233/dsh-exam-countdown/tar.gz/HEAD`
- **安装包名/版本**: `—` unknown · commit: 5449251
...
dsh plugin --profile web add https://codeload.github.com/zimai233/dsh-exam-countdown/tar.gz/HEAD --ignore-workspace-root-check
```

完整安装日志: [logs/dsh-exam-countdown.install.md](../logs/dsh-exam-countdown.install.md)

## English Summary

- **Install**: ❌ failed — `https://codeload.github.com/zimai233/dsh-exam-countdown/tar.gz/HEAD`
