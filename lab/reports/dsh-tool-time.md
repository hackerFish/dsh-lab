...
- **来源**: `https://codeload.github.com/omdsh-dev/dsh-tool-time/tar.gz/HEAD`
- **安装包名/版本**: `—` unknown · commit: bc55c35
...
dsh plugin --profile web add https://codeload.github.com/omdsh-dev/dsh-tool-time/tar.gz/HEAD --ignore-workspace-root-check
```

完整安装日志: [logs/dsh-tool-time.install.md](../logs/dsh-tool-time.install.md)

## English Summary

- **Install**: ❌ failed — `https://codeload.github.com/omdsh-dev/dsh-tool-time/tar.gz/HEAD`
