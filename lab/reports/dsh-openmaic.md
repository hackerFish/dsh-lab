...
- **来源**: `https://codeload.github.com/THU-MAIC/dsh-openmaic/tar.gz/HEAD`
- **安装包名/版本**: `—` unknown · commit: 09c1693
...
dsh plugin --profile web add https://codeload.github.com/THU-MAIC/dsh-openmaic/tar.gz/HEAD --ignore-workspace-root-check
```

完整安装日志: [logs/dsh-openmaic.install.md](../logs/dsh-openmaic.install.md)

## English Summary

- **Install**: ❌ failed — `https://codeload.github.com/THU-MAIC/dsh-openmaic/tar.gz/HEAD`
