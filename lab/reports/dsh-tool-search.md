...
- **来源**: `https://codeload.github.com/vibeinging/dsh-tool-search/tar.gz/HEAD`
- **安装包名/版本**: `—` unknown · commit: 265ce76
...
dsh plugin --profile web add https://codeload.github.com/vibeinging/dsh-tool-search/tar.gz/HEAD --ignore-workspace-root-check
```

完整安装日志: [logs/dsh-tool-search.install.md](../logs/dsh-tool-search.install.md)

## English Summary

- **Install**: ❌ failed — `https://codeload.github.com/vibeinging/dsh-tool-search/tar.gz/HEAD`
