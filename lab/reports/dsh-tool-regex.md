...
- **来源**: `https://codeload.github.com/omdsh-dev/dsh-tool-regex/tar.gz/HEAD`
- **安装包名/版本**: `—` unknown · commit: 457c84f
...
dsh plugin --profile web add https://codeload.github.com/omdsh-dev/dsh-tool-regex/tar.gz/HEAD --ignore-workspace-root-check
```

完整安装日志: [logs/dsh-tool-regex.install.md](../logs/dsh-tool-regex.install.md)

## English Summary

- **Install**: ❌ failed — `https://codeload.github.com/omdsh-dev/dsh-tool-regex/tar.gz/HEAD`
