...
- **来源**: `https://codeload.github.com/zimai233/dsh-video-downloader/tar.gz/HEAD`
- **安装包名/版本**: `—` unknown · commit: 48107ee
...
dsh plugin --profile web add https://codeload.github.com/zimai233/dsh-video-downloader/tar.gz/HEAD --ignore-workspace-root-check
```

完整安装日志: [logs/dsh-video-downloader.install.md](../logs/dsh-video-downloader.install.md)

## English Summary

- **Install**: ❌ failed — `https://codeload.github.com/zimai233/dsh-video-downloader/tar.gz/HEAD`
