...
- **来源**: `https://codeload.github.com/gongyijie85/dsh-repo-setup/tar.gz/HEAD`
- **安装包名/版本**: `—` unknown · commit: 9d745d0
...
dsh plugin --profile web add https://codeload.github.com/gongyijie85/dsh-repo-setup/tar.gz/HEAD --ignore-workspace-root-check
```

完整安装日志: [logs/dsh-repo-setup.install.md](../logs/dsh-repo-setup.install.md)

## English Summary

- **Install**: ❌ failed — `https://codeload.github.com/gongyijie85/dsh-repo-setup/tar.gz/HEAD`
