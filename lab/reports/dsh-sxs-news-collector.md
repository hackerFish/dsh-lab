...
- **来源**: `https://codeload.github.com/yangyunsong023/dsh-sxs-news-collector/tar.gz/HEAD`
- **安装包名/版本**: `—` unknown · commit: 0c72c77
...
dsh plugin --profile web add https://codeload.github.com/yangyunsong023/dsh-sxs-news-collector/tar.gz/HEAD --ignore-workspace-root-check
```

完整安装日志: [logs/dsh-sxs-news-collector.install.md](../logs/dsh-sxs-news-collector.install.md)

## English Summary

- **Install**: ❌ failed — `https://codeload.github.com/yangyunsong023/dsh-sxs-news-collector/tar.gz/HEAD`
