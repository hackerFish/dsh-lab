...
- **来源**: `https://codeload.github.com/yangyunsong023/dsh-sxs-anti-bot-http/tar.gz/HEAD`
- **安装包名/版本**: `—` unknown · commit: 5a956bf
...
dsh plugin --profile web add https://codeload.github.com/yangyunsong023/dsh-sxs-anti-bot-http/tar.gz/HEAD --ignore-workspace-root-check
```

完整安装日志: [logs/dsh-sxs-anti-bot-http.install.md](../logs/dsh-sxs-anti-bot-http.install.md)

## English Summary

- **Install**: ❌ failed — `https://codeload.github.com/yangyunsong023/dsh-sxs-anti-bot-http/tar.gz/HEAD`
