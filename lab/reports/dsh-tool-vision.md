...
- **来源**: `https://codeload.github.com/gloryxpnv/dsh-tool-vision/tar.gz/HEAD`
- **安装包名/版本**: `—` unknown · commit: 35789ca
...
dsh plugin --profile web add https://codeload.github.com/gloryxpnv/dsh-tool-vision/tar.gz/HEAD --ignore-workspace-root-check
```

完整安装日志: [logs/dsh-tool-vision.install.md](../logs/dsh-tool-vision.install.md)

## English Summary

- **Install**: ❌ failed — `https://codeload.github.com/gloryxpnv/dsh-tool-vision/tar.gz/HEAD`
