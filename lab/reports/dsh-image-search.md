...
- **来源**: `https://codeload.github.com/zimai233/dsh-image-search/tar.gz/HEAD`
- **安装包名/版本**: `—` unknown · commit: 95ac2b7
...
dsh plugin --profile web add https://codeload.github.com/zimai233/dsh-image-search/tar.gz/HEAD --ignore-workspace-root-check
```

完整安装日志: [logs/dsh-image-search.install.md](../logs/dsh-image-search.install.md)

## English Summary

- **Install**: ❌ failed — `https://codeload.github.com/zimai233/dsh-image-search/tar.gz/HEAD`
