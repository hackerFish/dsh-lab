...
- **来源**: `https://codeload.github.com/LoserFox/distill/tar.gz/HEAD`
- **安装包名/版本**: `—` unknown · commit: d2aaa39
...
dsh plugin --profile web add https://codeload.github.com/LoserFox/distill/tar.gz/HEAD --ignore-workspace-root-check
```

完整安装日志: [logs/distill.install.md](../logs/distill.install.md)

## English Summary

- **Install**: ❌ failed — `https://codeload.github.com/LoserFox/distill/tar.gz/HEAD`
