...
- **来源**: `https://codeload.github.com/omdsh-dev/dsh-tool-diff/tar.gz/HEAD`
- **安装包名/版本**: `—` unknown · commit: 73c142e
...
dsh plugin --profile web add https://codeload.github.com/omdsh-dev/dsh-tool-diff/tar.gz/HEAD --ignore-workspace-root-check
```

完整安装日志: [logs/dsh-tool-diff.install.md](../logs/dsh-tool-diff.install.md)

## English Summary

- **Install**: ❌ failed — `https://codeload.github.com/omdsh-dev/dsh-tool-diff/tar.gz/HEAD`
