...
- **来源**: `https://codeload.github.com/Luke-Yong/dsh-plugin-knowledge-graph/tar.gz/HEAD`
- **安装包名/版本**: `—` unknown · commit: c5e8005
...
dsh plugin --profile web add https://codeload.github.com/Luke-Yong/dsh-plugin-knowledge-graph/tar.gz/HEAD --ignore-workspace-root-check
```

完整安装日志: [logs/dsh-plugin-knowledge-graph.install.md](../logs/dsh-plugin-knowledge-graph.install.md)

## English Summary

- **Install**: ❌ failed — `https://codeload.github.com/Luke-Yong/dsh-plugin-knowledge-graph/tar.gz/HEAD`
