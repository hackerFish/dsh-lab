...
- **来源**: `https://codeload.github.com/chushixixin/dsh-harness-mcp-server/tar.gz/HEAD`
- **安装包名/版本**: `—` unknown · commit: d174cea
...
dsh plugin --profile web add https://codeload.github.com/chushixixin/dsh-harness-mcp-server/tar.gz/HEAD --ignore-workspace-root-check
```

完整安装日志: [logs/dsh-harness-mcp-server.install.md](../logs/dsh-harness-mcp-server.install.md)

## English Summary

- **Install**: ❌ failed — `https://codeload.github.com/chushixixin/dsh-harness-mcp-server/tar.gz/HEAD`
