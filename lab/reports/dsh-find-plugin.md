...
- **来源**: `https://codeload.github.com/awesome-dsh-plugin/dsh-find-plugin/tar.gz/HEAD`
- **安装包名/版本**: `—` unknown · commit: e75dc2e
...
dsh plugin --profile web add https://codeload.github.com/awesome-dsh-plugin/dsh-find-plugin/tar.gz/HEAD --ignore-workspace-root-check
```

完整安装日志: [logs/dsh-find-plugin.install.md](../logs/dsh-find-plugin.install.md)

## English Summary

- **Install**: ❌ failed — `https://codeload.github.com/awesome-dsh-plugin/dsh-find-plugin/tar.gz/HEAD`
