...
- **来源**: `https://codeload.github.com/ciceroyang/dsh-report-studio/tar.gz/HEAD`
- **安装包名/版本**: `—` unknown · commit: ba34f83
...
dsh plugin --profile web add https://codeload.github.com/ciceroyang/dsh-report-studio/tar.gz/HEAD --ignore-workspace-root-check
```

完整安装日志: [logs/dsh-report-studio.install.md](../logs/dsh-report-studio.install.md)

## English Summary

- **Install**: ❌ failed — `https://codeload.github.com/ciceroyang/dsh-report-studio/tar.gz/HEAD`
