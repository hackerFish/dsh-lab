...
- **来源**: `https://codeload.github.com/omdsh-dev/dsh-tool-schema/tar.gz/HEAD`
- **安装包名/版本**: `—` unknown · commit: 8d9a652
...
dsh plugin --profile web add https://codeload.github.com/omdsh-dev/dsh-tool-schema/tar.gz/HEAD --ignore-workspace-root-check
```

完整安装日志: [logs/dsh-tool-schema.install.md](../logs/dsh-tool-schema.install.md)

## English Summary

- **Install**: ❌ failed — `https://codeload.github.com/omdsh-dev/dsh-tool-schema/tar.gz/HEAD`
