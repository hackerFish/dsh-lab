...
- **来源**: `https://codeload.github.com/omdsh-dev/dsh-tool-encoding/tar.gz/HEAD`
- **安装包名/版本**: `—` unknown · commit: 5baa75f
...
dsh plugin --profile web add https://codeload.github.com/omdsh-dev/dsh-tool-encoding/tar.gz/HEAD --ignore-workspace-root-check
```

完整安装日志: [logs/dsh-tool-encoding.install.md](../logs/dsh-tool-encoding.install.md)

## English Summary

- **Install**: ❌ failed — `https://codeload.github.com/omdsh-dev/dsh-tool-encoding/tar.gz/HEAD`
