...
- **来源**: `https://codeload.github.com/canghai666x/dsh-news-plugin/tar.gz/HEAD`
- **安装包名/版本**: `—` unknown · commit: 2303163
...
dsh plugin --profile web add https://codeload.github.com/canghai666x/dsh-news-plugin/tar.gz/HEAD --ignore-workspace-root-check
```

完整安装日志: [logs/dsh-news-plugin.install.md](../logs/dsh-news-plugin.install.md)

## English Summary

- **Install**: ❌ failed — `https://codeload.github.com/canghai666x/dsh-news-plugin/tar.gz/HEAD`
