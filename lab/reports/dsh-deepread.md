...
- **来源**: `https://codeload.github.com/xiehuan123/dsh-deepread/tar.gz/HEAD`
- **安装包名/版本**: `—` unknown · commit: cbfffab
...
dsh plugin --profile web add https://codeload.github.com/xiehuan123/dsh-deepread/tar.gz/HEAD --ignore-workspace-root-check
```

完整安装日志: [logs/dsh-deepread.install.md](../logs/dsh-deepread.install.md)

## English Summary

- **Install**: ❌ failed — `https://codeload.github.com/xiehuan123/dsh-deepread/tar.gz/HEAD`
